...
const schema = yup.object().shape({
  ...
  position: yup.string().required("Chuyên ngành là bắt buộc"),
});
...
const EditStaffAccount = () => {
  const { updateAccStaff, getInfoUserHasRole } = useAdmin();
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Đổi thông tin nhân viên</Text>
      ...
      <RenderUser user={accountDetails} requireRole={Role.STAFF} />
    </ScrollView>
  );
};
